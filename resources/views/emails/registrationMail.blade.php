                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                Welcome to  {{ ucfirst($details['product']) }}
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                Thank you for signing up for {{ ucfirst($details['product']) }}. We're really happy to have
                                        ...
                                        <td align="center"
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;"
                                                    valign="middle">
                                                        <a href="{{url('download_pdf/'.$details['user_id'])}}" target="_blank" rel="noopener noreferrer" style="text-decoration:none;">
                                                            <p style="color:#fff; font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                                Download PDF
                                                            </p>
                                                        </a>
                                                    </td>
                                        ...
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                <a href="https://www.htmlemailtemplates.net"
                                                    style="color:#2F67F6">htmlemailtemplates.net</a>
                                            </div>
